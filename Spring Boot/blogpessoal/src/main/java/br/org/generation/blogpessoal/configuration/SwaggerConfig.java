...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Blog Pessoal")//Define o titulo da sua aplicação que será exibida na documentação.
	...
	private static Contact contact() { //Define os dados do Desenvolvedor (Nome, Website e o E-mail).
		...
		return new Contact("Giovanni Cerqueira", "https://github.com/Giovanni-SVC", "gsilvacerqueira@hotmail.com");
